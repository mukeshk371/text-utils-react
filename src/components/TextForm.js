    ...
    return (
        <>
            <div className={`container text-${props.mode === 'dark' ? 'light' : 'dark'}`}>
                ...
                <button className="btn btn-outline-primary ms-2 my-2" onClick={handleLowClick}>Convert to Lowercase</button>
                <button className="btn btn-success ms-2 my-2" onClick={handleClearClick}>Clear</button>
                <button className="btn btn-info ms-2 my-2" onClick={handleCopyClick}>Copy</button>
            </div>
